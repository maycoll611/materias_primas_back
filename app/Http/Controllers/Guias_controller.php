...

{
    ...
    public function get_guias_correlativo(Request $request){
        try{    
            $resp['cliente'] = DB::table('ventas')
                                ...
                                ->where('ventas.venta_correlativo','=',$request->correlativo)
                                ->first();
            ...
            $resp['materiales'] = DB::table('dtventas')
                                ->select('*')
                                ->where('dtventa_correlativo','=',$request->correlativo)
                                ->get();
            ...
            $resp['venta'] = DB::table('ventas')
                            ->join('empresas','ventas.ventas_cliente_ruc','=','empresas.empresa_ruc')
                            ->join('usuarios','ventas.venta_usuario_envia','=','usuarios.usuario_id')
                            ->select('ventas.venta_correlativo',
    ...
    public function get_guias(Request $request){
        ...
        ->orderBy('ventas.venta_correlativo', 'desc');
    ...
    public function guardar_guia(Request $request){
        ...
        try {
            ...
            $data_1 = [
                'dtventa_correlativo'=>$correlativo1,
